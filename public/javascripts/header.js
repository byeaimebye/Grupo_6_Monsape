window.addEventListener("scroll", () => {
  if(window.scrollY >= 100){
     ...
     document.querySelector(".prueba").style.transition= "5s"
     document.querySelector(".logoCenter img").style.display= "none"
     document.querySelector(".prueba").style.borderBottom= "1px white solid"
     ...
     document.querySelector(".logoCenter img").style.transition= "5s"
